      ...
      <div className={`login-page ${showRegister ? "show-register" : ""}`}>
        ...
        {showRegister && (
          <form className="register-form" onSubmit={handleRegisterSubmit}>
            ...
            {loading ? (
              <p style={{ color: '#c71585', textAlign: 'center' }}>Loading streams...</p>
            ) : role === "student" ? (
              ...
              <>
                <label style={{ display: 'block', textAlign: 'left', marginTop: '0.5rem', color: '#c71585' }}>
        ...
        {showAnimation && (
          <div className="registration-success-animation">
            <img src={regSuccessGif} alt="Success" className="anime-animation" />
